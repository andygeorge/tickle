...
fn test_compose_file_detection_docker_compose_yml() {
    ...
    fs::write(test_dir.join("docker-compose.yml"), "version: '3'").expect("Failed to create file");
...
fn test_compose_file_detection_compose_yaml() {
    ...
    fs::write(test_dir.join("compose.yaml"), "version: '3'").expect("Failed to create file");
